...
return [
    'date' => [
        'last_week' =>  'You are :years years old.',
        'last_year' => 'السنة الماضية',
        'this_week' => 'هذا الأسبوع',
        'this_year' => 'هذا العام',
    ],

    'test' => [    'message' => 'You are  years old.' ],

    'passport' => [
        'loggedin'              => 'تم تسجيل الدخول بنجاح',
        'registered'             => 'تم انشاء حسابك بنجاح',
        'invalid_credintals'     => 'اسم مستخدم او كلمه مرور خاطئه',
        'email_doesnt_exists'    => 'لا يوجد حساب بهذا الايميل',
        'send_sms_rest_code'     => 'تم ارسال رمز الاسترجاع لهاتفك :phone',
        'invalid_rest_code'      => 'رمز استرجاع خاطئ',
        'wrong_old_password'      => 'كلمه المرور القديمه خاطئه',
        'passwords_match'        => 'لا يمكنك استخدام كلمه المرور القديمه',
        'new_passwords_mismatch' => 'كلمه المرور لا تطابق تاكيد كلمه المرور',
        'changed_password'       => 'تم تغيير كلمه المرور بنجاح',
        'failed_change_password' => 'فشل تغيير كلمه المرور',
    ],

    'errors' => [
      'input_data' => 'خظأ في البيانات المدخله',
      'system_error' => 'خظأ في النظام',
      'insufficient_tickets' => 'لا يوجد تذاكر كافيه لطلبك .عدد التذاكر المتوفره :ticket',
      'unauthorized_opreation' => 'ليس لديك الصلاحيه للقيام بهذه العملية'
    ],
    ...
    'generic' => [
        ...
        'submit'                 => 'إرسال',
        'successfully_added_new' => 'تمت إضافة :new جديد بنجاح',
        'successfully_deleted'   => 'تم حذف :new بنجاح',
        'successfully_updated'   => 'تم التحديث :new بنجاح',
        'successfully_found'   => 'تم وجود :new بنجاح',
