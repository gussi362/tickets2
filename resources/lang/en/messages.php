...
return [
    ...
    'passport' => [
        ...
        'invalid_credintals'     => 'wrong username or password',
        'email_doesnt_exists'    => 'email doesn\'t exists',
        'send_sms_rest_code'     => 'reset code was sent to your phone :phone',
        'invalid_rest_code'      => 'invalid reset code',
        'wrong_old_password'     => 'wrong old password',
        'passwords_match'        => 'you can\'t use the old password',
        'new_passwords_mismatch' => 'new password and confirmation doesn\'t match',
        'changed_password'       => 'password changed succesffuly',
        'failed_change_password' => 'failed to change password',
    ],

    'errors' => [
      'input_data' => 'invalid data were entered',
      'system_error' => 'system error',
      'insufficient_tickets' => 'no sufficient tickets for your order ,available tickets  :ticket',
      'unauthorized_opreation' => 'you aren\'t authorized to do this opreation'
    ],
    ...
    'generic' => [
        ...
        'submit'                 => 'إرسال',
        'successfully_added_new' => 'added new :new successfully',
        'successfully_deleted'   => 'deleted :new successfully',
        'successfully_updated'   => 'updated :new successfully',
        'successfully_found'     => 'found :new successfully',
